...
def check_buildings(br):
	...
	try:
		...
		senate.click()
		print("The Sanate is being inspected.")
		err_senate = False
		time.sleep(2)
	except:
...
def footer(br):
	...
	for i in range(0, wait_time):
		...
		print("Time spent["+ "▇" * z + " " *(20-z) + "] " + str(percent_done) + "%" + " " + str(wait_time - i) + " seconds", end="\r")
